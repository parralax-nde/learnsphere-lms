...
const styles = {
  ...
  successBox: { backgroundColor: '#dcfce7', border: '1px solid #86efac', borderRadius: '8px', padding: '20px', textAlign: 'center' },
  successIcon: { fontSize: '40px', marginBottom: '12px' },
  successTitle: { fontSize: '18px', fontWeight: '700', color: '#166534', marginBottom: '8px' },
  successText: { fontSize: '14px', color: '#166534', lineHeight: '1.5' },
};
      ...
      <div style={styles.card}>
        ...
        {registered ? (
          ...
          <>
            ...
            <p style={styles.subheading}>Join LearnSphere and start learning today.</p>
